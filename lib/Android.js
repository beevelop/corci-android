...
var multiGlob = P.promisify(Common.multiGlob);
...
function Android(buildfolder) {
    ...
    Logger.android('Yolo'); //@todo: remove test
}
...
Android.prototype.ensureLocalProperties = function () {
    ...
    if (androidHomeEnv) {
        ...
        var _this = this;
        return whereisAsync('android').then(function (androidFile) {
